  ...
  <div>
    ...
    <el-dialog title="申请" :visible.sync="addVisible" width="30%">
      <el-form ref="form" :model="form" label-width="70px" >
        <el-form-item label="原因" label-width="100px" prop="roleName">
          <el-input v-model="form.reason"></el-input>
        </el-form-item>
        <el-form-item label="申请类型" label-width="100px" prop="roleName">
        ...
        <el-form-item label="开始时间" label-width="100px" prop="roleName">
          <el-date-picker
        ...
        <el-form-item label="结束时间" label-width="100px" prop="roleName">
          <el-date-picker
